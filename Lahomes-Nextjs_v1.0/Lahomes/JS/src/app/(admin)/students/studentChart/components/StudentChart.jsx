          ...
          <Card className="shadow-lg border-0 rounded-4 mb-4"style={{width:'80%'}}>
            <Row className="h-100">
              <Col md={6} className="d-flex flex-column justify-content-center p-4">
                <Card.Body>
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li><p className='fs-16'><strong>Total Task:</strong> {totalTasks}</p></li>
                    <li><p className='fs-16'><strong>Completed Task:</strong> {completedTasks}</p></li>
                    <li><p className='fs-16'><strong>Pending Task:</strong> {notCompletedTasks}</p></li>
              ...
              {series && series.length > 0 && options && (
                <ReactApexChart options={options} series={series} type="donut" width={350} height={350} />
               )}
